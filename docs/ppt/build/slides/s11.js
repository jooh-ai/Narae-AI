...
module.exports = (pptx, T, meta, D) => {
  ...
  /* '양 끝은 좁다' 고 적어 두지 않는다 — 회차가 쌓이면 폭이 바뀐다.
     가장 좁은 곳과 가장 넓은 곳을 데이터에서 뽑아 말한다. */
  d.txt('가장 좁은 곳은 ' + narrow.t + '℃ 로 ' + narrow.gap.toFixed(2) + ' 차이뿐이고, ' +
        wide.t + '℃ 에서 ' + wide.gap.toFixed(2) + ' 까지 벌어집니다. 눈으로는 고를 수 없습니다.',
        772, 590, 436, 2);
