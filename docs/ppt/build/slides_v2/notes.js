...
"그런데 이 넷은 서로 온도에 묶여 있습니다. 진공도와 온도의 관련성이
 ${sign(Z.rows[1].vs_t)} 입니다. 사실상 온도의 함수입니다."

"그래서 온도로 설명되는 몫을 먼저 걷어내고 다시 쟀습니다. 진공도와 대기압은
 사라졌습니다. 습도만 ${sign(Z.rows[3].part)} 로 남았는데, 온도를 직선이 아니라
 곡선으로 걷어내니 그것도 임계 ${Z.rcrit.toFixed(2)} 아래로 내려갔습니다."
