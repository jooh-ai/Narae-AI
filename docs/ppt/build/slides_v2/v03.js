...
module.exports = (pptx, T, meta, D) => {
  ...
  T.title(d, '엑셀 4개로 하던 일을 도구 하나로,', '하나로 정하던 값을 *데이터로*', { w: 1040 });
  ...
  d.sub('온도와 무관한 ~하나의 값~ 으로', 96, 508, 500, 1, C.slate);
  ...
  d.text('※ 누적 ' + D.n + '회 실적에 종전 방식과 현재 도구를 각각 적용해 채점한 ' +
         '재현값입니다 (한 회를 가리고 나머지로 예측 · LOOCV ' + D.n_score +
         '회, 미달은 ±0.5% 밴드). 실제 신고 이력이 아닙니다.',
         { x: G.L, y: 620, w: G.W, px: 11, lh: 1.3, color: C.dim2 });
