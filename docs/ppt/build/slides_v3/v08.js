...
module.exports = (pptx, T, meta, D) => {
  ...
  d.text('실제로 알린 기록이 아닙니다. 같은 데이터에 두 방법을 써 본 값입니다.',
  ...
  d.text('도구가 엑셀과 같은 답을 내는지 맞춰 보다가 드러났습니다.\n' +
         '대기압을 우리는 7일 평균으로 썼는데, 엑셀은 5일 평균이었습니다.',
         { x: 92, y: 470, w: 540, px: 13.5, lh: 1.6, lines: 4, color: C.body });
  d.rect(664, 466, 4, 130, C.brass);
  d.text('고치는 방법도 한 번 틀렸습니다.', { x: 684, y: 466, w: 504, px: 15.5,
                                             lh: 1.35, bold: true, color: C.ink });
  d.text('처음에는 골라 쓰게 만들려 했습니다. 그런데 현장은 하나로 정해져 있었습니다.\n' +
