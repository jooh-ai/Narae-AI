...
'use strict';
const ITEM = [
  ['기존 방식',   '예전에 숫자를 만든 방법',       '04', '① 개요 및 추진 배경'],
  ['문제점',      '절차 · 똑같은 값 · 어긋난 숫자', '05', '② 현황 파악 및 문제 정의'],
  ['원인',        '무엇 때문에 어긋났나',           '06', '③ 데이터 분석 및 원인 규명'],
  ['개선 방안',   '온도마다 다르게 배우기',         '07', '④ 해결 방안 및 모델 개발'],
  ['개선 효과',   '얼마나 좋아졌나',                '08', '⑥ 개선 효과'],
  ['넘어온 과정', '막혔던 것과 푼 방법',            '09', '별도'],
  ['유지 관리',   '시험이 쌓이면 스스로 갱신',      '10', '⑤ 모니터링 체계 구축'],
  ['향후 계획',   '다른 발전소에도 쓰기',           '11', '⑦ 향후 계획 및 수평 전개'],
];
