...
const ITEM = [
  ...
  ['문제점',      '무엇이 문제였나',              '04', '② 현황 파악 및 문제정의'],
  ['원인',        '무엇 때문에 어긋났나',          '05', '③ 데이터 분석 및 원인 규명'],
  ['해결 방안',   '바꾼 것 두 가지',              '06', '④ 해결방안 및 모델 개발'],
  ['모니터링',    '실제로 쓰면서 확인',            '07', '⑤ 향후 추이 분석' ],
  ['개선효과',    '정량 — 시간과 정확도',          '08', '⑥ 개선효과 (정량)'],
  ['개선효과',    '정성 — 일하는 방식',            '09', '⑥ 개선효과 (정성)'],
  ['향후 계획',   '다른 발전소에도 쓰기',          '10', '⑦ 향후계획 및 수평전개'],
];
module.exports = (pptx, T, meta, D) => {
  ...
  d.text('참고', { x: 132, y: 590, w: 60, px: 11.5, lh: 1.2, mono: true, bold: true,
                    color: C.dim2 });
  d.text('넘어온 과정', { x: 200, y: 586, w: 150, px: 17, lh: 1.3, color: C.dim });
  d.text('막혔던 것 · 푼 방법 · 역할 분담', { x: 362, y: 591, w: 440, px: 13,
                                               lh: 1.3, color: C.dim2 });
