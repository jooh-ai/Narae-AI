...
const ITEM = [
  ...
  ['해결 방안',   '개선 방안',                    '06', '④ 해결방안 도출'],
  ['해결 방안',   '회귀 모델 선정',                '07', '④ 예측/보정 모델 개발'],
  ['모니터링',    '넉 달 병행 운전',               '08', '⑤ 향후 추이 분석' ],
  ['개선효과',    '정량 — 시간 · 정확도 · 요금',    '09', '⑥ 개선효과 (정량)'],
  ['개선효과',    '정성 — 일하는 방식',            '10', '⑥ 개선효과 (정성)'],
  ['향후 계획',   '정확도 향상과 수평 전개',        '11', '⑦ 향후계획 및 수평전개'],
];
