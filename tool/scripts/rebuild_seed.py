...
무엇을 고치는가 (근거가 확정된 것만)
  ...
  4) 2025-04-15 제외 — IGV Turn-up 미실시 판단 (EXCLUDE 주석 참조).
...
#
# 왜 아직 제외인가
#   IGV 미실시가 담당자 확인으로 확정되지 않았다. 확정되면 W=0 으로 넣는 것이
#   맞다 — 제외할 이유가 없어진다. 같은 시기 저온 4건(03-12·03-19·04-03·04-08)도
#   함께 넣을 수 있고, 그러면 10~20°C(입찰 실무 온도대이면서 누적이 가장 얇은
#   구간)가 크게 보강된다.
#
#       python -m wirye_capacity add --date 2025-04-15 --cit 13.69 --press 995.83 \
#              --rh 35.5 --cc 438.10 --w 0 --season 봄·가을
#
EXCLUDE = {
    "2025-04-15": "IGV Turn-up 미실시 판단 — 담당자 확인 후 W=0 으로 add",
}
